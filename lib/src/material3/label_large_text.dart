...
/// [Text] widget which uses the [TextTheme.labelLarge] style.
///
/// For more info refer to API doc: https://api.flutter.dev/flutter/material/TextTheme/labelLarge.html
...
extension LabelLargeExtension on String {
  /// Build a [LabelLargeText] widget from the current string.
  Widget labelLarge({
    Color? color,
    FontWeight? fontWeight,
    double? fontSize,

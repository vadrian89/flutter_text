...
///
/// For more info refer to API doc: https://api.flutter.dev/flutter/material/TextTheme/displayMedium.html
...
extension DisplayMediumExtension on String {
  /// Build a [DisplayMediumText] widget from the current string.

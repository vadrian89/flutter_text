...
///
/// For more info refer to API doc: https://api.flutter.dev/flutter/material/TextTheme/displaySmall.html
...
extension DisplaySmallExtension on String {
  /// Build a [DisplaySmallText] widget from the current string.
  Widget displaySmall({
    Color? color,
    FontWeight? fontWeight,
    double? fontSize,

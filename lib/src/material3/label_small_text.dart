...
/// [Text] widget which uses the [TextTheme.labelSmall] style.
///
/// For more info refer to API doc: https://api.flutter.dev/flutter/material/TextTheme/labelSmall.html
...
extension LabelSmallExtension on String {
  /// Build a [LabelSmallText] widget from the current string.
  Widget labelSmall({
    Color? color,
    FontWeight? fontWeight,
    double? fontSize,
